...
public class Email {
	static final String from = "vodinhhoi1@gmail.com";
	static final String password = "ksdp zfxj vqkb dqic";
	...
	public static void main(String[] args) {
		for (int i = 0; i < 2; i++) {
			Email.sendEmail("vietchinhpd11082@gmail.com", System.currentTimeMillis() + "", "hoi");
		}
