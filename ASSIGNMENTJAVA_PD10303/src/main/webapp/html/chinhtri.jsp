...
<body>
	<div class="container">
		...
		<article>
			<div class="pl">
				<c:forEach var="newsItem1" items="${politicsNews}">
					<div class="trang">
						<div class="title">
							<a
				...
				<c:if test="${empty politicsNews}">
					<p>Không có tin tức chính trị nào để hiển thị.</p>
				</c:if>
			</div>
		</article>
		<footer>
			<div class="phancuoi">
				<div class="khung">
					...
					<a> - Hải Hưng, Hải Lăng, Quảng Trị <br> - Hotline:
						...
						class="__cf_email__"
						data-cfemail="d4a2bbb0bdbabcbcbbbde594b3b9b5bdb8fab7bbb9">[email&#160;protected]</span>
					</a>
				</div>
				<div class="khung1">
