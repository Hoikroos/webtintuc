	...
	<div class="container">
		...
		<article>
			<div class="card-header">
				<h2>
					<i class="fas fa-tags"></i> Quản Lý Loại Tin
				</h2>
			</div>

			<div class="tabs">
				<div class="tab active" data-tab="form">Thêm/Sửa Loại Tin</div>
				<div class="tab" data-tab="list">Danh Sách Loại Tin</div>
			</div>

			<div class="tab-content active" id="form-tab">
				<div class="form-container">
					<h3 class="form-title">
						<i class="fas fa-plus-circle"></i> ${item.id != null ? 'Cập Nhật Loại Tin' : 'Thêm Loại Tin Mới'}
					</h3>

					<c:url var="path" value="/catego" />
					<form method="post">
						<div class="form-row">
							<div class="form-group form-group-half">
								<label for="category-id" class="form-label">ID:</label> <input
									type="text" id="category-id" name="id" class="form-control"
									value="${item.id}" required>
							</div>

							<div class="form-group form-group-half">
								<label for="category-name" class="form-label">Tên Loại
									Tin:</label> <input type="text" id="category-name" name="name"
			...
			<div class="tab-content" id="list-tab">
				<div class="table-responsive">
					<table>
						...
						<tbody>
							<c:forEach var="cate" items="${list}" varStatus="vs">
								<tr>
									<td>${vs.index + 1}</td>
									<td>${cate.id}</td>
									<td>${cate.name}</td>
									<td class="table-actions">
										<form method="post" action="${path}/edit/${cate.id}"
										...
										<form method="post" action="${path}/delete"
											style="display: inline;"
											onsubmit="return confirm('Bạn có chắc chắn muốn xóa loại tin này?');">
