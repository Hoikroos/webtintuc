...
<body>
	<div class="container">
		...
		<article>
			<div class="pl">
				<c:forEach var="newsItem1" items="${educationsNews}">
					<div class="trang">
						<div class="title">
							<a
								href="${pageContext.request.contextPath}/news-display?id=${newsItem1.id}">
								<p style="font-size: 16px;">${newsItem1.title}</p>
							</a>
						</div>
						<div class="imagevh">
							<a
								href="${pageContext.request.contextPath}/news-display?id=${newsItem1.id}">
								<img src="/ASSIGNMENTJAVA_PD10303/${newsItem1.image}" alt=""
						...
						<div class="content">
							<a
								href="${pageContext.request.contextPath}/news-display?id=${newsItem1.id}">
								<p style="font-size: 10px;">${fn:substring(newsItem1.content, 0, 200)}</p>
							</a>
						</div>
						<div class="date">
							Ngày đăng:
							<fmt:formatDate value="${newsItem1.postedDate}"
								pattern="dd/MM/yyyy" />
						</div>
						<div class="author">Tác giả: ${newsItem1.author}</div>
					</div>
				</c:forEach>

				<!-- Thông báo nếu không có tin tức nào -->
				<c:if test="${empty politicsNews}">
					<p>Không có tin tức giáo dục nào để hiển thị.</p>
				</c:if>
			</div>
		</article>
		<footer>
			<div class="phancuoi">
				...
				<div class="khung1">
					...
					<a href="#">- Tổng đài tư vấn</a><a href="#">- Liên
						hệ</a><a href="#">- Hỗ trợ</a>
				</div>
				<div class="khung2">
				...
				<div class="khung3">
					<h3>Trụ Sở</h3>
					<a href="#">- Giới thiệu</a><a href="#">- Tin tức</a>
					<a href="#">- Tuyển dụng</a><a href="#">- Hệ thống
						công ty</a>
				</div>
			</div>
		</footer>
